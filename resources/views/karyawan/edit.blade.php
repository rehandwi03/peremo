    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="exampleModalLabel1">Edit Karyawan</h4>
            ...
            <div class="modal-body">
                <form action="{{ route('karyawan.update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="nomor_telp" class="form-control" id="no_telp_karyawan">
                    </div>
                    <div class="form-group">
                        <label for="alamat_karyawan">Alamat Karyawan</label>
                        <textarea name="alamat_karyawan" cols="30" rows="10" class="form-control"
                            id="alamat_karyawan"></textarea>
                    </div>
